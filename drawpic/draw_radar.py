...
def example_data():
    ...
    for index in range(0, len(language_list)):
        ...
        count = get_tool_entity_number(projects)
        ...
        for project_name in projects:
            with open("../count_file/" + project_name + ".csv", 'r') as file:
...
def get_tool_entity_number(project:list):
    ...
    for project_name in project:
        for tool_name in tool_list:
            path = "../input_dir/" + project_name + "/" + tool_name + "_" + project_name + "_entity.json"
            with open(path, 'r') as file:
                data = json.load(file)
                count[tool_name] = count[tool_name] + len(data['entity'])
    return count
...
if __name__ == '__main__':
    ...
    colors = ['y', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b']
